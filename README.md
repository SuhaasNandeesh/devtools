...
*   **Update Sync & Offline Changelog**: Background GitHub Release sync (with 12-hour local caching and offline-first safety) that alerts you when a newer version is published. Prompts an offline-first markdown Changelog modal on the very first start after an upgrade to display What's New immediately.
